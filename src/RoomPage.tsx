...
import { faSquare, faThLarge, faUserFriends, faComments } from '@fortawesome/free-solid-svg-icons';
...
export const RoomPage = () => {
  ...
  const [isChatVisible, setChatVisible] = useState<boolean>(false); // State to toggle chat window
  ...
  const getParticipantName = (room: Room) => {
      ...
      <div className="roomContainer">
        <div className="topBar">
          ...
          <div className="right">
            ...
            >
              <FontAwesomeIcon height={32} icon={faComments} /> {/* Chat icon */}
            </button>
          </div>
        </div>
        <LiveKitRoom
          ...
          onConnected={(room) => {
            ...
            setParticipantName(getParticipantName(room)); // Set participant name
          ...
          onLeave={onLeave}
        />
        {isChatVisible && <ChatComponent participantName={participantName} />} {/* Conditionally render chat */}
        <Symbl
